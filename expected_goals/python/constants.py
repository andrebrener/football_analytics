...
for c in ['pos_dest_x_range', 'pos_started_pos_x_range', 'pos_x_range']:
    FIXED_DUMMIES[c] = ['very_close', 'close', 'mid_range', 'long_range']

for c in ['pos_dest_y_range', 'pos_started_pos_y_range', 'pos_y_range']:
...
COLS_TO_INSERT = [
    'sequence_number', 'game_id', 'possession_number', 'xg', 'xa',
    'pos_xg_chain', 'pos_xg_buildup'
]
